...
static bool parse_arguments(int argc, char **argv, Options *opts) {
    // Set defaults
...
static bool setup_input_file(const Options *opts, file_t *file) {
...
static int compile_and_execute(ASTNode_t *root, const Options *opts) {
